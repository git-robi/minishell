...
SRCS = src/builtins/functions/ft_echo.c src/builtins/functions/ft_export.c src/builtins/functions/ft_exit.c src/builtins/functions/ft_unset.c src/builtins/functions/ft_env.c src/builtins/functions/ft_cd.c src/builtins/functions/ft_pwd.c src/builtins/utils/env_list.c src/builtins/utils/export_list.c src/builtins/utils/call_builtin_function.c src/main.c src/mini_loop.c  src/lexer/lexer.c src/lexer/store_tokens.c src/lexer/list_utils_lexer.c src/lexer/quotes.c src/lexer/lexer_utils.c src/utils/strarr_utils.c  src/utils/str_utils.c src/utils/free_memory.c src/parser/parser.c src/parser/list_utils_parser.c src/parser/parser_utils.c src/executor/executor.c src/executor/heredoc.c src/executor/multiple_commands.c src/executor/path_finder.c src/executor/redirections.c 
OBJS = $(SRCS:.c=.o)
